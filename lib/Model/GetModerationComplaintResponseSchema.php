<?php
/**
 * GetModerationComplaintResponseSchema
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GetModerationComplaintResponseSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetModerationComplaintResponseSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetModerationComplaintResponseSchema';
    ...
    protected static $swaggerTypes = [
        'items' => '\Swagger\Client\Model\GetModerationComplaintResponseItemSchema[]',
        'total_count' => 'int'
    ];
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\GetModerationComplaintResponseItemSchema[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\GetModerationComplaintResponseItemSchema[] $items Жалобы
     *
     * @return $this
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Общее количество
     *
     * @return $this
     */
