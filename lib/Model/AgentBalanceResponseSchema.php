...
/**
 * AgentBalanceResponseSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AgentBalanceResponseSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AgentBalanceResponseSchema';
     ...
     * Sets auction_points
     *
     * @param double $auction_points Суммарный баланс неистекших баллов на аукцион
     *
     * @return $this
     */
     ...
     * Sets balance
     *
     * @param double $balance Полный суммарный баланс пользователя на текущий момент. Включает все виды денег (бонусы и т.п.)
     *
     * @return $this
     */
