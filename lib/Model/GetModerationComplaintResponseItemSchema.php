<?php
/**
 * GetModerationComplaintResponseItemSchema
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GetModerationComplaintResponseItemSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetModerationComplaintResponseItemSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetModerationComplaintResponseItemSchema';
     ...
     * Sets creation_date
     *
     * @param \DateTime $creation_date Дата создания
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string $text Текст жалобы. Содержит Html
     *
     * @return $this
     */
