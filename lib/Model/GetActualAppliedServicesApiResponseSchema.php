<?php
/**
 * GetActualAppliedServicesApiResponseSchema
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GetActualAppliedServicesApiResponseSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetActualAppliedServicesApiResponseSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetActualAppliedServicesApiResponseSchema';
    ...
    protected static $swaggerTypes = [
        'items' => '\Swagger\Client\Model\OfferAppliedServicesModelSchema[]'
    ];
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\OfferAppliedServicesModelSchema[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\OfferAppliedServicesModelSchema[] $items Объявления с подключенными услугами
     *
     * @return $this
     */
