...
/**
 * OffersViewsStatsByDaysSchema Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OffersViewsStatsByDaysSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OffersViewsStatsByDaysSchema';
     ...
     * Sets views
     *
     * @param int $views Количество просмотров по дням
     *
     * @return $this
     */
